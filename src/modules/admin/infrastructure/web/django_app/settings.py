"""Django settings for GT-Vision VMS."""
import os
...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", default="gtvision"),
        "USER": config("DB_USER", default="gtvision"),
        "PASSWORD": config("DB_PASSWORD", default="gtvision_password"),
